...
const siteData = {
  ...
  catalog: [
    { code: 'K5', name: 'Liquid Room Freshener', flavor: 'Divine Aura', category: 'freshners', image: '/images/freshners/Divine%20Aura%20LF.png', desc: 'A rich, balanced fragrance that creates a premium, welcoming atmosphere in any room.', dilution: 'Spray: 1:1 dilution (1 part freshener + 1 part water). Mop on Surface: 70ml to 100ml in 1 liter of water.' },
    { code: 'K5', name: 'Liquid Room Freshener', flavor: 'French Rose', category: 'freshners', image: '/images/freshners/frenchrose%20LF.png', desc: 'A soft floral scent with a classic rose profile that keeps spaces fresh and elegant.', dilution: 'Spray: 1:1 dilution (1 part freshener + 1 part water). Mop on Surface: 70ml to 100ml in 1 liter of water.' },
    { code: 'K5', name: 'Liquid Room Freshener', flavor: 'Fresh Flora', category: 'freshners', image: '/images/freshners/Fresh%20Flora%20LF.png', desc: 'A fresh floral note that brings the spirit of a blooming garden into every room.', dilution: 'Spray: 1:1 dilution (1 part freshener + 1 part water). Mop on Surface: 70ml to 100ml in 1 liter of water.' },
    { code: 'K5', name: 'Liquid Room Freshener', flavor: 'Garden Bloom', category: 'freshners', image: '/images/freshners/garden%20bloom%20LF.png', desc: 'A vibrant floral freshness with a breezy green note that feels clean and uplifting.', dilution: 'Spray: 1:1 dilution (1 part freshener + 1 part water). Mop on Surface: 70ml to 100ml in 1 liter of water.' },
    { code: 'K5', name: 'Liquid Room Freshener', flavor: 'Green Apple', category: 'freshners', image: '/images/freshners/Green%20Apple%20LF.png', desc: 'A crisp, juicy fragrance that energizes interiors with a bright, refreshing mood.', dilution: 'Spray: 1:1 dilution (1 part freshener + 1 part water). Mop on Surface: 70ml to 100ml in 1 liter of water.' },
    { code: 'K5', name: 'Liquid Room Freshener', flavor: 'Harmony', category: 'freshners', image: '/images/freshners/Harmony%20LF.png', desc: 'A smooth, balanced scent that creates a calm and pleasant atmosphere throughout spaces.', dilution: 'Spray: 1:1 dilution (1 part freshener + 1 part water). Mop on Surface: 70ml to 100ml in 1 liter of water.' },
    ...
    { code: 'K5', name: 'Liquid Room Freshener', flavor: 'Millennium Lavender', category: 'freshners', image: '/images/freshners/Lavender%20LF.png', desc: 'A soothing lavender fragrance that promotes a calm, clean, and comforting ambiance.', dilution: 'Spray: 1:1 dilution (1 part freshener + 1 part water). Mop on Surface: 70ml to 100ml in 1 liter of water.' },
    { code: 'K5', name: 'Liquid Room Freshener', flavor: 'Magical Brutus', category: 'freshners', image: '/images/freshners/Magical%20Brutus%20LF.png', desc: 'A bold and memorable fragrance profile designed to leave a lasting fresh impression.', dilution: 'Spray: 1:1 dilution (1 part freshener + 1 part water). Mop on Surface: 70ml to 100ml in 1 liter of water.' },
    { code: 'K5', name: 'Liquid Room Freshener', flavor: 'Mystic Dream', category: 'freshners', image: '/images/freshners/Mystic%20Dream%20LF.png', desc: 'A dreamy, modern fragrance that creates a soft, soothing atmosphere in enclosed spaces.', dilution: 'Spray: 1:1 dilution (1 part freshener + 1 part water). Mop on Surface: 70ml to 100ml in 1 liter of water.' },
    { code: 'K5', name: 'Liquid Room Freshener', flavor: 'Golden Sandel', category: 'freshners', image: '/images/freshners/sandel%20LF.png', desc: 'A warm, woody aromatic fragrance that gives room spaces a premium and earthy finish.', dilution: 'Spray: 1:1 dilution (1 part freshener + 1 part water). Mop on Surface: 70ml to 100ml in 1 liter of water.' },
    { code: 'K5', name: 'Liquid Room Freshener', flavor: 'Strawberry Shot', category: 'freshners', image: '/images/freshners/strawberry%20LF.png', desc: 'A sweet, fruity strawberry fragrance that keeps interiors airy, cheerful, and fresh.', dilution: 'Spray: 1:1 dilution (1 part freshener + 1 part water). Mop on Surface: 70ml to 100ml in 1 liter of water.' },
    { code: 'K1', name: 'Disinfectant Surface Cleaner (With Sanitizer) Concentrate', flavor: 'Lemon Fresh', category: 'cleansers', image: '/images/cleansers/K1_Disinfectant_Surface_Cleaner_Lemon.png', desc: 'Fresh lemon-scented disinfectant surface cleaner designed for routine floor and hard-surface hygiene.', dilution: 'Normal Soiling: 8ml in 1 liter of water. Heavy Soiling: 10ml to 12ml in 1 liter of water.' },
    { code: 'K1', name: 'Disinfectant Surface Cleaner (With Sanitizer) Concentrate', flavor: 'Millennium Lavender', category: 'cleansers', image: '/images/cleansers/K1_Disinfectant_Surface_Cleaner_Lavender.png', desc: 'Calming lavender-infused disinfectant surface cleaner that leaves surfaces sparkling clean with a soothing fragrance.', dilution: 'Normal Soiling: 8ml in 1 liter of water. Heavy Soiling: 10ml to 12ml in 1 liter of water.' },
    { code: 'K2', name: 'Multi-Purpose Cleaner Concentrate', flavor: 'French Rose', category: 'cleansers', image: '/images/cleansers/K2_Multipurpose___French_Rose.png', desc: 'A versatile cleaning concentrate effective on floors, walls, and household surfaces for everyday maintenance.', dilution: 'Glass Surface: 5ml in 1 liter of water. Hard Surface: 20ml to 40ml in 1 liter of water.' },
    { code: 'K2', name: 'Multi-Purpose Cleaner Concentrate', flavor: 'Orange Zest', category: 'cleansers', image: '/images/cleansers/K2_Multiprupose%20Liquid%20Orange.png', desc: 'A lively orange-scented cleaner that cuts through grease and grime while refreshing the space.', dilution: 'Glass Surface: 5ml in 1 liter of water. Hard Surface: 20ml to 40ml in 1 liter of water.' },
    ...
    { code: 'K6', name: 'Toilet Bowl Cleaner', flavor: 'Cool Breeze', category: 'cleansers', image: '/images/cleansers/K6_Toilet_Bowl_Cleaner.png', desc: 'Powerful thick formula that removes tough stains and limescale while disinfecting toilet bowls.', dilution: 'Ready to use. Little quantity sufficient. Wet surface before use.' },
    { code: 'K7', name: 'Hard Surface Cleaner', flavor: 'Lemon Fresh', category: 'cleansers', image: '/images/cleansers/K7_Hard%20Surface%20Cleaner.png', desc: 'A robust hard-surface cleaner designed for daily use on tiles, counters, and regular floor areas.', dilution: 'Normal Soiling: 25ml in 1 liter of water. Heavy Soiling: 50ml in 1 liter of water.' },
    { code: 'K8', name: 'Dish Wash Liquid (Bio-Degradable)', flavor: 'Lemon Fresh', category: 'cleansers', image: '/images/cleansers/K8_Dishwash%20Liquid.png', desc: 'Effective dishwashing liquid that cuts through grease and leaves utensils sparkling clean.', dilution: 'Use up to 50ml in 1 liter of water.' },
    { code: 'K9', name: 'Bathroom Ceramic Cleaner Concentrate', flavor: 'Mild & Gentle', category: 'cleansers', image: '/images/cleansers/K9_Bathroom%20Ceramic%20Cleaner.png', desc: 'Anti-bacterial formula designed for complete hygiene on bathroom surfaces, tiles, and ceramic fixtures.', dilution: 'Normal Soiling: 200ml in 1 liter of water (once a week). Heavy Soiling: 400ml in 1 liter of water (thrice a week). Wet surface before use.' },
    { code: 'K10', name: 'Hand Wash Liquid (Soft & Antiseptic)', flavor: 'Royal Cream', category: 'cleansers', image: '/images/cleansers/K10_Handwash_Royal%20Touch.png', desc: 'Luxury handwash formulation that cleanses gently while leaving skin soft and refreshed.', dilution: 'Ready to use. Dispense as required through a handwash dispenser.' },
    { code: 'K10', name: 'Hand Wash Liquid (Soft & Antiseptic)', flavor: 'Strawberry Shot', category: 'cleansers', image: '/images/cleansers/K10_Handwash_Strawberry.png', desc: 'A bright strawberry-scented hand wash that keeps hands fresh, clean, and pleasant to use.', dilution: 'Ready to use. Dispense as required through a handwash dispenser.' },
    { code: 'K11', name: 'Hand Sanitizer Concentrate', flavor: 'Original', category: 'cleansers', image: '/images/cleansers/K11_Hand%20Sanitizer.png', desc: 'Quick-drying sanitizing solution for efficient hygiene control in high-touch areas.', dilution: 'Ready to use. Apply to palms and rub until dry.' },
    { code: 'K12', name: 'Ultra-Scale Care', flavor: 'Original', category: 'cleansers', image: '/images/cleansers/K12_Ultra%20Scale%20Remover.png', desc: 'Powerful descaling product used to remove mineral buildup and restore shine to surfaces.', dilution: 'Use 100ml to 200ml in 1 liter of water depending on scale buildup.' },
    { code: 'K15', name: 'Laundry Detergent', flavor: 'Original', category: 'cleansers', image: '/images/cleansers/k15_Matic%20Liquid.png', desc: 'Dependable laundry detergent formulated for effective fabric cleaning and routine laundry care.', dilution: '60ml to 80ml of laundry detergent for 10kg of fabric.' },
    { code: 'K16', name: 'Fabric Conditioner', flavor: 'Pink Elixir', category: 'cleansers', image: '/images/cleansers/K16_Fabric%20Conditioner.png', desc: 'Softening formulation that improves fabric feel while keeping textiles fresh and pleasant.', dilution: 'Use as recommended on the product label or dosing instructions.' },
      ...
      <div class="product-card${p.code === 'K2' && p.flavor === 'French Rose' ? ' product-card--french-rose' : ''}" data-index="${i}" data-category="${p.category}">
        ...
        <div class="product-card-body">
          <div class="product-card-tags">
            <span class="product-card-category">${p.category === 'freshners' ? 'Freshener' : 'Cleaner'}</span>
          </div>
...
function openCatalogModal(p) {
  const catLabel = p.category === 'freshners' ? 'Freshener' : 'Cleaner';
  ...
  openModal(`
    <div class="pip">
      ...
      <div class="pip-content-col">
        ...
        <div class="pip-section">
          <h4 class="pip-section-title"><i class="fas fa-exclamation-circle"></i> Emergency Information</h4>
          <p class="pip-app-text">Detailed safety data is provided in Material Safety Data Sheet (MSDS).</p>
        </div>
...
function openDirectQuoteModal(productName, productFlavor) {
  ...
  var catLabel = cat === 'freshners' ? 'Freshener' : 'Cleaner';
