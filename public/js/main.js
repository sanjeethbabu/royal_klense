...
const siteData = {
  ...
  catalog: [
    ...
    { code: 'K10', name: 'Hand Wash', flavor: 'Royal Cream', category: 'cleansers', image: '/images/cleansers/K10_Handwash_Royal%20Touch.png', desc: 'Luxury handwash formulation that cleanses gently while leaving skin soft and refreshed.', dilution: 'Ready to use. Dispense as required through a handwash dispenser.' },
